<template>
  ...
  <p align="center">
    <button @click="employeeReg()">Регистрация</button>
  </p>
  <p v-if="errorMessage === 'user-exists'" align="center" style="color: red">Работник уже зарегистрирован</p>
  <p v-if="isOk === 'ok'" align="center" style="color: green">Работник зарегистрирован</p>
</template>
<script setup>
import { ref } from 'vue';
...
async function employeeReg() {
  ...
  try {
    const result = await axios.post('/api/employee/create', data);
